...
namespace ENTITY
{
	...
	static Vector3 GET_ENTITY_COORDS(Entity p0, float p1, float p2) { return invoke<Vector3>(0xA86D5F069399F44D, p0, p1, p2); } // 0xA86D5F069399F44D b1207
...
namespace MISC
{
	...
	static BOOL GET_GROUND_Z_FOR_3D_COORD(Any p0, Any p1, Any p2, float p3, Any p4) { return invoke<BOOL>(0x24FA4267BB8D2431, p0, p1, p2, p3, p4); } // 0x24FA4267BB8D2431 b1207
	...
	static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS(float p0, float p1, float p2, float p3, float p4, float p5, int p6, bool p7, Hash p8, Ped p9, BOOL p10, BOOL p11, BOOL p12, float p13) { invoke<Void>(0x867654CBC7606F2C, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13); } // 0x867654CBC7606F2C b1207
...
namespace PED
{
	...
	static void PED_STAMINA(Ped p0, float p1) { invoke<Void>(0x675680D089BFA21F, p0, p1); } // 0x675680D089BFA21F b1207
